...
<?php 
	...
	if(isset($_POST['Edit']))
	{
		...
		if ($ekstensifile == "PNG")(($ekstensifile == "png") or ($ekstensifile == "jpg"));
		{
			move_uploaded_file($file_tmp, 'images/'.$namafile); //unggah file ke folder images
			mysqli_query($connection, "update restaurant set restaurantNAMA='$namarestaurant', restaurantALAMAT='$alamatrestaurant',restaurantDES='$desrestaurant',restaurantREVIEW='$reviewrestaurant',restaurantFOTO='$namafile'
	...
	$editdestinasi = mysqli_query ($connection, "select * from restaurant
		where restaurantKODE = '$koderestaurant'");
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="koderestaurant" name="inputrestaurant" placeholder="Kode Restoran" maxlength="4" value="<?php echo $rowedit ["restaurantKODE"]?>"readonly>
			</div>
		</div>
    ...
    <legend class="col-form-label col-sm-2 pt-0">REVIEW RESTAURANT</legend>
    <div class="col-sm-10">
