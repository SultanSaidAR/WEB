...
if(isset($_POST['simpan']))
{
    ...
    mysqli_query($connection, "insert into penerbangan values('$penerbanganKODE','$penerbanganNAMA','$penerbanganJENIS','$penerbanganTUJUAN')");
}
?>
...
<body>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="kodepenerbangan" placehold="" name="kodepenerbangan"></div>
    </div>
    <div class="mb-3 row">
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
			<select class="form-control" aria-label="Default select example" id="jenispenerbangan" name="jenispenerbangan">
				<option>1way</option>
                <option>2way</option>
			</select>
			</div>
...
<!--form pencarian-->
    <div class="form-group row mb-2">
        <label for="search" class="col-sm-2">kode penerbangan</label>
            <div class="col-sm-8">
...
<?php
    ...
    <tr>
      ...
      <td>
					...
					<a href="dbpenerbanganedit.php?ubah=<?php echo $row["penerbanganKODE"]?>"
