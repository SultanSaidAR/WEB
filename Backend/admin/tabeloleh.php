...
<?php 
	...
	if(isset($_POST['Simpan']))
	{
		...
		if(($ekstensifile == "png") or ($ekstensifile == "PNG"))
		{
			...
			mysqli_query($connection, "insert into oleh value ('$kodeoleh', '$namaoleh','$asaloleh','$reviewoleh','$namafile')");
...
<label for="search" class="col-sm-2">nama oleh</label>
<div class="col-sm-8">
<input type="text" name="search" class="form-control" id="search" 
				value="<?php if(isset($POST['search'])) {echo $_POST['search'];} ?>"
				placeholder="Cari nama oleh">
</div>
...
<div class="row">
	...
	<div class="col-sm-10">
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h1 class="display-4"style="color : white">Daftar oleh-oleh</h1>
			</div>
		</div>
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-title">Nama Oleh-Oleh: <?php echo $row['olehNAMA']; ?></p>
                        <p class="card-text">Kode Oleh-Oleh: <?php echo $row['olehKODE']; ?></p>
                        <p class="card-text">Asal Oleh-Oleh: <?php echo $row['olehASAL']; ?></p>
                        <p class="card-text">Review Oleh-Oleh: <?php echo $row['olehREVIEW']; ?></p>
