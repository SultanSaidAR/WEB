...
<?php 
	...
	if(isset($_POST['Edit']))
	{
		...
		if(($ekstensifile == "png") or ($ekstensifile == "PNG")or ($ekstensifile == "jpg"))
		{
			...
			mysqli_query($connection, "update travel set travelNAMA='$namatravel', travelLOKASI='$LOKASItravel',travelTEL='$teltravel',travelFOTO='$namafile'
				where travelKODE='$kodetravel'");
			header("location:dbtravel.php");
		}
...
<div class="col-sm-10">
    <h1>Input Travel</h1>
        ...
        <div class="col-md-6">
            <label for="kodetravel" class="form-label">Kode Travel</label>
            <input type="text" class="form-control" id="kodetravel" name="inputtravel" placeholder="Kode Travel" maxlength="4"value="<?php echo $rowedit ["travelKODE"]?>"readonly>
        </div>
        ...
        <div class="col-md-4">
            <label for="LOKASItravel" class="form-label">Lokasi Travel</label>
            <select id="LOKASItravel" class="form-select" name="inputlokasi">
        ...
        <div class="col-md-4">
            <label for="teltravel" class="form-label">Telephone Travel</label>
            <input type="text" class="form-control" id="namatravel" name="inputtel" placeholder="Nomor Telephone"maxlength="13">
        </div>

        <div class="col-md-4">
            <label for="inputfoto" class="form-label">Input Foto Travel</label>
