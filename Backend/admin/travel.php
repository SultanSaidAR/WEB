...
<?php 
	...
	if(isset($_POST['Simpan']))
	{
		...
		if(($ekstensifile == "png") or ($ekstensifile == "PNG")or ($ekstensifile == "jpg"))
		{
			...
			mysqli_query($connection, "insert into travel value ('$kodetravel', '$namatravel','$lokasitravel', '$teltravel','$namafile')");
...
<div class="col-sm-10">
    <h1>Input Travel</h1>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="kodetravel" name="inputtravel" placeholder="Kode Travel" maxlength="4">
        </div>
        ...
        <div class="col-md-4">
            ...
            <select id="lokasitravel" class="form-control" name="inputlokasi">
