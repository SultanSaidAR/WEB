...
<?php 
	...
	if(isset($_POST['Edit']))
	{
		...
		if(($ekstensifile == "png") or ($ekstensifile == "PNG")or ($ekstensifile == "jpg"))
		{
			...
			mysqli_query($connection, "update destinasi set destinasiNAMA='$destinasiNAMA', kategoriKODE='$kategoriKODE', destinasiKET='$kategoriKET',
            destinasiFOTO='$namafile' where destinasiKODE='$destinasiKODE'");
