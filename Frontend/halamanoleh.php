...
$oleh1= mysqli_query($connection, "select * from oleh ");

$kodeoleh = $_GET["olehkode"];
	$pkoleh = mysqli_query ($connection, "select * from oleh
		where olehkode = '$kodeoleh'");
        $rowedit = mysqli_fetch_array($pkoleh);
...
<div class="container"><!--membuat kolom berita-->
 ...
 <div class="container-xxl py-5">
                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-2">
                            <h6 class="position-relative text-primary ps-4">Pusat Oleh-Oleh Pilihan Anda</h6>
                            <h2 class="mt-2"><?php echo $rowedit["olehNAMA"];?></h2>
                        </div>
                        <p class="mb-4"><?php echo $rowedit["olehDES"];?></p>
                        <p class="mb-4"><?php echo $rowedit["olehASAL"];?></p>
                        <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="ADMIN/images/<?php echo $rowedit["olehFOTO"];?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="judul" style="text-align:center;"><h2>Daftar Pusat Oleh-Oleh</h2></div>
        <br>

        <div class="row g-4 portfolio-container">
        <?php
       
       if (mysqli_num_rows($oleh1)>0)
       {
         while($rowoleh=mysqli_fetch_array($oleh1))
       {
        ?>
                    <div class="col-lg-4 col-md-6 portfolio-item first wow zoomIn" data-wow-delay="0.1s">
                        <div class="position-relative rounded overflow-hidden"style="height:300px;">
                            <img class="img-fluid w-100" src="ADMIN/images/<?php echo $rowoleh["olehFOTO"];?>" alt="">
                            <div class="portfolio-overlay">
                                <a class="btn btn-light" href="ADMIN/images/<?php echo $rowoleh["olehFOTO"];?>" data-lightbox="portfolio"><i class="fa fa-plus fa-2x text-primary"></i></a>
                                <div class="mt-auto">
                                    <small class="text-white">Rating :<?php echo $rowoleh["olehREVIEW"];?></small>
                                    <a class="h5 d-block text-white mt-1 mb-0" href=""><?php echo $rowoleh["olehNAMA"];?></a>
                                </div>
                            </div>
                        </div>
                    </div>
