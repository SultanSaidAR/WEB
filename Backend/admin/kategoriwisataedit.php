    ...
    if(isset($_POST['Edit']))
{
    ...
    mysqli_query($connection, "update kategoriwisata set kategoriNAMA='$kategoriNAMA', kategoriKET='$kategoriKET', kategoriREFFERENCE='$kategoriREFFERENCE'
		where kategoriKODE='$kategoriKODE'");
        header("location:dashbordkategori.php");
 
	}
 
	$kodedestinasi = $_GET["ubah"];
	$editdestinasi = mysqli_query ($connection, "select * from kategoriwisata
		where kategoriKODE = '$kodedestinasi'");
...
<html lang="en">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="kategoriKODE" name="inputkategoriKode" placeholder="kode kategori wisata" value="<?php echo $rowedit ["kategoriKODE"]?>"readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    <label for="kategoriREFFERENCE" class="col-sm-3 col-form-label">Referensi Kategori Wisata</label>
    <div class="col-sm-7">
      <input type="text" class="form-control" id="kategoriREFFERENCE"  name="inputkategoriRefference"placeholder="referensi kategori wisata">
    </div>
  </div>
