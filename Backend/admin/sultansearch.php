...
if(isset($_POST['simpan']))
{
    ...
    mysqli_query($connection, "insert into sultan values('$hotel0151','$hotelNAMA','$hotelALAMAT','$kategori0151')");
...
<body>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="kodehotel" placehold="" name="kodehotel" maxlength="4"></div>
    </div>
    <div class="mb-3 row">
